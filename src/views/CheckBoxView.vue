...
import CheckBoxSize from '@/features/Control/CheckBox/components/CheckBoxSize/CheckBoxSize.vue'
...
<template>
  <PageLayout
    title="CheckBox"
    importCode="import { CheckBox } from '@/components/Control'"
    :desc="t.lang.checkbox.desc"
  >
    <template #showcase>
      <CheckBoxBasic />
      <CheckBoxColor />

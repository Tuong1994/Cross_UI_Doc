...
import FormValidation from '@/features/Control/Form/components/FormValidation/FormValidation.vue'
...
<template>
  <PageLayout title="Form" importCode="import { Form } from '@/components/Control'" :desc="t.lang.form.desc">
    <template #showcase>
      <FormBasic />
      <FormColor />
      <FormSize />

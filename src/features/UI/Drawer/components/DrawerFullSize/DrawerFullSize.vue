...
<template>
  <AnchorContent :id="drawerCatalogIds.FULL">
    <ShowCase title="Full size" :vueCode="drawerFullSizeVueCode" :reactCode="drawerFullSizeReactCode">
      ...
      <Drawer full :open="open" @onClose="handleOpenDrawer">
        ...
        <template #body>
          ...
          accusamus, id ipsam ullam delectus possimus enim modi! Repellat aliquam cum veniam sit ipsum illum
          sed expedita, ipsam cumque doloremque molestias harum? Voluptatibus nihil laboriosam similique
          veniam corporis, quisquam in ullam sit voluptas reiciendis ea perferendis illum omnis accusantium
          alias! Error laboriosam et expedita sint eos aperiam aspernatur delectus laborum. Asperiores,
          quaerat? Quasi ex eius inventore quaerat itaque voluptas voluptate recusandae in, nihil
          voluptatibus? Quisquam commodi soluta accusantium explicabo, officia, hic delectus inventore aperiam
          quo, quam consequuntur provident. Impedit minus, nihil aut obcaecati ex qui dicta vero tempore
          repellat ad aperiam nulla architecto debitis, quis alias asperiores temporibus unde aliquid. Officia
          explicabo velit magnam voluptatem ut ex qui eveniet!
        </template>
      </Drawer>
    </ShowCase>
  </AnchorContent>

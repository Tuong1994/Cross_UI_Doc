...
import { paragraphBasicReactCode, paragraphBasicVueCode } from './code'
...
<template>
  <AnchorContent :id="typographyCatalogIds.PARAGRAPH_BASIC">
    <ShowCase title="Basic" code="" :vueCode="paragraphBasicVueCode" :reactCode="paragraphBasicReactCode">
      <Paragraph>

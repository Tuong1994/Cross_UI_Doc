...
import { paragraphAlignsReactCode, paragraphAlignsVueCode } from './code'
...
<template>
  <AnchorContent :id="typographyCatalogIds.PARAGRAPH_ALIGNS">
    <ShowCase title="Aligns" code="" :vueCode="paragraphAlignsVueCode" :reactCode="paragraphAlignsReactCode">
      ...
      <Title :level="6" aligns="left">Left</Title>
      ...
      <Title :level="6" aligns="center">Center</Title>
      ...
      <Title :level="6" aligns="right">Right</Title>

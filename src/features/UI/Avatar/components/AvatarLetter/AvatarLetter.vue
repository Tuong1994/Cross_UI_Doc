...
import { avatarLetterReactCode, avatarLetterVueCode } from './code'
...
<template>
  <AnchorContent :id="avatarCatalogIds.LETTER">
    <ShowCase title="Letter" code="" :vueCode="avatarLetterVueCode" :reactCode="avatarLetterReactCode">
      <Space>

export const layoutBasicVueCode = `
...
export const layoutBasicReactCode = `
import { Layout } from "./components/UI";
    ...
    <Container>
      ...
      <Body>
        ...
        <Content>
          ...
          possimus similique eaque, minima nesciunt voluptates natus quam! Et quasi mollitia magni voluptatum
          repellat. Itaque magnam quisquam vero harum nam nihil fugiat, aut omnis dolores, commodi minus
          perspiciatis sapiente cumque voluptatem impedit. Magnam molestiae, voluptate itaque harum sunt
          ducimus quos animi quaerat repudiandae quibusdam beatae vero sit placeat obcaecati nesciunt optio
          sint hic ipsum laudantium inventore libero magni et. Voluptas mollitia accusantium facere ullam
          reiciendis impedit dolorem recusandae animi maiores! Nobis natus, iure impedit similique quos
          commodi, velit at cupiditate fugit rerum repudiandae ullam inventore minus modi!
        </Content>
      </Body>
    </Container>
  );

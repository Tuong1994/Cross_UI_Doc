...
export const carouselProductReactCode = `
...
const App: React.FC = () => {
  ...
  return <Product style={style} items={items} slideId="carouselProduct" />;
};

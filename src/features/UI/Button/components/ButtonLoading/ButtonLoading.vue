...
import { buttonLoadingReactCode, buttonLoadingVueCode } from './code'
...
<template>
  <AnchorContent :id="buttonCatalogIds.LOADING">
    <ShowCase title="Loading" :vueCode="buttonLoadingVueCode" :reactCode="buttonLoadingReactCode">
      <Space>

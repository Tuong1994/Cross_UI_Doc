...
import { fileShapeReactCode, fileShapeVueCode } from './code'
...
<template>
  <AnchorContent :id="uploadCatalogIds.FILES_UPLOAD_SHAPE">
    <ShowCase title="Shape" :vueCode="fileShapeVueCode" :reactCode="fileShapeReactCode">
      <Space>

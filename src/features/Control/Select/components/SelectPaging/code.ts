export const selectPagingVueCode = `
...
export const selectPagingReactCode = `
import { Select } from "@/components/Control";
...
const App: React.FC = () => {
  ...
  return <Select async total={100} limit={10} options={options} onChangePage={handleChangePage} />;
};

...
import { typographyCatalogIds } from '@/features/Typography/repository/catalogIds'
import { paragraphUnderlineCode } from './code'
...
<template>
  <AnchorContent :id="typographyCatalogIds.PARAGRAPH_UNDERLINE">
    <ShowCase title="Paragraph underline" :code="paragraphUnderlineCode">
      <Paragraph underline>

const textarea_vn = {
  ...
  api: {
    textareaDesc: {
      ...
      rootStyle: 'Style nội tuyến cho vùng bao ngoài',
      labelStyle: 'Style nội tuyến cho nhãn',
      inputStyle: 'Style nội tuyến cho ô nhập liệu',
      modelValue: 'Giá trị mặc định của ô nhập',
      name: 'Tên của control',
      placeholder: 'Văn bản gợi ý trong ô nhập',
      sizes: 'Kích thước của ô nhập',
      color: 'Chủ đề màu sắc của ô nhập',
      shape: 'Hình dạng của ô nhập',

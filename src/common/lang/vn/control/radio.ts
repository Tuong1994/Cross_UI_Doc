const radio_vn = {
  desc: 'Dùng để chọn một trạng thái duy nhất từ nhiều tùy chọn',
  api: {
    radioDesc: {
      rootClassName: 'Tên lớp của vùng chứa',
      labelClassName: 'Tên lớp của nhãn',
      controlClassName: 'Tên lớp của điều khiển radio',
